...
const gchar *gui =
    ...
    ">10</property>"
    "                <property name=" row_homogeneous
    ">True</property>"
    "                <child>"
    "                  <object class=" GtkButton " id=" uiselectwindow
    ">"
    "                    <property name=" label " translatable=" yes
    ">Select a window</property>"
    "                    <property name=" visible
    ">True</property>"
    "                    <property name=" can_focus
    ">True</property>"
    ...
    ">center</property>"
    "                    <signal name=" state -
    set " handler=" minimize_toggled " swapped=" no
        "/>"
        "                  </object>"
        "                  <packing>"
        "                    <property name=" left_attach
...
int main(int argc, char *argv[]) {
    ...
    if (0 == result = gtk_builder_add_from_string((builder, gui, -1, &err)) {
